		...
		<h1>Tableau de Bord</h1>
			...
			<form id="basicForm" action="{{route('vols.store')}}" method="POST"  class="form-horizontal">
				...
				<div class="form-group">
		            ...
		            <div class="col-sm-6">
		               <input type="text" name="code" placeholder="Code du vol" required="required" class="form-control" />
		            </div>
            	</div>
            	...
            	<div class="form-group">
		            <label class="col-sm-3 control-label"></label>
		            <div class="col-sm-6">
		               <input type="number" name="place" placeholder="Nombre de place"  class="form-control" />
		            </div>
            	</div>
            	...
            	<div class="form-group">
		            <label class="col-sm-3 control-label"></label>
		            <div class="col-sm-6">
		               <input type="time" name="duree" placeholder="Durée du vol"  class="form-control" />
		            </div>
            	</div>
            	...
            	<div class="form-group">
		            <label class="col-sm-3 control-label"></label>
		            <div class="col-sm-6">
		               <input type="text" name="destination" placeholder="Destination du vol"  class="form-control" />
		            </div>
            	</div>
